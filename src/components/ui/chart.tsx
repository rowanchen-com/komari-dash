  ...
  (
    ...
    return (
      ...
      >
        ...
        <div className={cn("grid gap-1.5 bg-white px-2.5 py-1.5 dark:bg-black", { "border-t": !nestLabel })}>
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div className={cn("flex flex-1 justify-between leading-none", nestLabel ? "items-end" : "items-center")}>
                      ...
                      {item.value && (
                        <span className={cn("ml-2 font-medium text-foreground tabular-nums", payload.length === 1 && "-ml-9")}>
                          {typeof item.value === "number" ? item.value.toFixed(2).toLocaleString() : item.value}{" "}
                        </span>
                      )}
                    </div>
                  </>
